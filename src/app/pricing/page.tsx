    ...
    plans: {
      ...
      pro: {
        ...
        bullets: [
          ...
          "Decel Intelligence (McBurnie 2022) — 5-dim early ACL/hamstring radar",
          "Sharp Cut load (Dos'Santos 2021) — cutting volume vs personal norm",
          "MPE Recovery (Osgnach 2023) — early fatigue from recovery-time drift",
          "GPS Load Monitoring — 7D / 28D / ACWR per player + team",
          "Mechanical Load Index (MLI) — decel, accel, CoD, PlayerLoad density",
          "Metabolic Load Score — power-corrected (Brown 2016), HMLD, fatigue type",
          "Quadrant View (Gabbett 2017) — readiness × load sweet-spot tracking",
    ...
    plans: {
      ...
      pro: {
        ...
        bullets: [
          ...
          "Adaptive Training Engine",
          "Neural Fatigue Model",
          "Decel Intelligence (McBurnie 2022) — 5-vídda ACL/aftanlæri radar",
          "Sharp Cut load (Dos'Santos 2021) — skerping vs persónulegt norm",
          "MPE Recovery (Osgnach 2023) — snemma þreyta úr endurheimt-tíma",
          "GPS Load Monitoring — 7D / 28D / ACWR per leikmaður + lið",
          "Mechanical Load Index (MLI) — hæðnun, hægðun, snúningur, PlayerLoad",
          "Metabolic Load Score — power-corrected (Brown 2016), HMLD, þreytugerð",
          "Quadrant View (Gabbett 2017) — readiness × álag sweet-spot",
