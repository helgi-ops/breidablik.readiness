  ...
  EN: {
    ...
    plans: {
      ...
      elite: {
        ...
        note: "Adds match & player analytics (StatsBomb / Wyscout), the VALD assessment suite, and the AI translation layer on top of Pro.",
        bullets: [
          "Everything in Pro plus:",
          "📊 Match & opponent analytics (StatsBomb / Wyscout) — single-match, season, best-match & opponent scouting",
          "👤 Player season & transfer analytics (StatsBomb / Wyscout) — stat explorer, season profiles, transfer reports, form-vs-state",
          "🩺 VALD assessment suite — Return-to-Play, ForceFrame benchmark bands, Load-Velocity profiling",
    ...
    compare: {
      ...
      rows: [
        ...
        ["Match & opponent analytics (StatsBomb / Wyscout)", "—", "—", "—", "✅"],
        ["Player season & transfer analytics (StatsBomb / Wyscout)", "—", "—", "—", "✅"],
        ["VALD assessment suite (RTP, ForceFrame bands, Load-Velocity)", "—", "—", "—", "✅"],
        ["🧠 AI Player Summary", "—", "—", "—", "✅"],
  ...
  IS: {
    ...
    plans: {
      ...
      elite: {
        ...
        note: "Bætir leik- & leikmannagreiningu (StatsBomb / Wyscout), VALD mælingapakka og AI túlkunarlagi ofan á Pro.",
        bullets: [
          "Allt í Pro +",
          "📊 Leik- & andstæðingagreining (StatsBomb / Wyscout) — stakur leikur, tímabil, bestu leikir & andstæðinga-skátun",
          "👤 Leikmanna-tímabils- & félagaskiptagreining (StatsBomb / Wyscout) — tölfræði, tímabilsprófílar, félagaskiptaskýrslur, form-vs-ástand",
          "🩺 VALD mælingapakki — Return-to-Play, ForceFrame viðmiðunarbönd, kraft-/hraðaprófun",
    ...
    compare: {
      ...
      rows: [
        ...
        ["Neural fatigue model", "—", "—", "✅", "✅"],
        ["Catapult API live sync", "—", "—", "✅", "✅"],
        ["Leik- & andstæðingagreining (StatsBomb / Wyscout)", "—", "—", "—", "✅"],
        ["Leikmanna-tímabils- & félagaskiptagreining (StatsBomb / Wyscout)", "—", "—", "—", "✅"],
        ["VALD mælingapakki (RTP, ForceFrame bönd, kraft-/hraði)", "—", "—", "—", "✅"],
        ["🧠 AI Player Summary", "—", "—", "—", "✅"],
        ["💬 AI Q&A (8 spurningar)", "—", "—", "—", "✅"],
        ["🧠 Decel Narrative AI", "—", "—", "—", "✅"],
        ["Spá fyrir morgundag", "—", "—", "—", "✅"],
