...
export default function LoginPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (mode === "signup") {
        // Ef þú ert með email confirmations ON í Supabase, þá fær user email og þarf að staðfesta.
        // Annars verður hann skráður inn strax.
  ...
  options: {
    ...
    emailRedirectTo:
      typeof window !== "undefined"
        ...
        // Ef confirmation er krafist: session verður null
        if (!data.session) {
