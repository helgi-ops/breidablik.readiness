      ...
      {!loading && !error && teamId && players.length > 0 && (
        <details className="rounded-xl border border-slate-200 bg-white">
          ...
          <div className="space-y-6 border-t border-slate-100 p-4">
            {/* Signal check + Robustness watch (#5) moved to their own page,
                /coach/readiness-signals (readiness/injury explainability, not
                the load-coupling story this page tells). */}
