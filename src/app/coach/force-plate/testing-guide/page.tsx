 ...
 * VALD Assessment page (/coach/force-plate). Print button → Save as PDF.
 */
  ...
  return (
    <div id="rtpguide" className="mx-auto w-full max-w-4xl p-4 md:p-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <Link href="/coach/force-plate" className="rtp-noprint text-xs text-zinc-500 hover:text-zinc-700">← {isEN ? "VALD Assessment" : "VALD-mat"}</Link>
