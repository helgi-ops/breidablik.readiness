    ...
    <div className="mx-auto max-w-5xl space-y-5 p-4">
      <div>
        ...
        <p className="mt-0.5 text-[12px] text-slate-500">
          {T(
            "Upload a test's clips once — the same clips drive both the pose measurement AND the AI read (the qualitative eye that points you to a region). Then record the assessment and prescribe. Screening & training only — not a diagnosis; pain / red flags route to a clinician. Never the readiness colour.",
            "Hladdu upp klippum prófs einu sinni — sömu klippur keyra bæði pose-mælinguna OG AI-lesturinn (eigindlega augað sem beinir þér að svæði). Skráðu svo matið og ávísaðu. Aðeins skimun & þjálfun — ekki greining; verkur / rauð flögg fara til klíníkers. Aldrei readiness-liturinn.",
          )}
        </p>
      </div>
