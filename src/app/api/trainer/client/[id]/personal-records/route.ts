/**
 * /api/trainer/client/[id]/personal-records — PRs for one of the trainer's
 * clients. Same engine as the client endpoint; trainer access check.
 */
...
export async function GET(req: Request, ctx: { params: Promise<{ id: string }> }) {
  ...
  const pr = await computePersonalRecords(a.sb, clientId);
