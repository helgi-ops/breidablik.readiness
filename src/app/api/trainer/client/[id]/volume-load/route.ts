/**
 * /api/trainer/client/[id]/volume-load — weekly tonnage for one of the
 * trainer's clients. Same computation as the client endpoint; trainer access.
 */
...
export async function GET(req: Request, ctx: { params: Promise<{ id: string }> }) {
  ...
  const volume = await computeVolumeLoad(a.sb, clientId);
