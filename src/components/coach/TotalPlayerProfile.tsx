...
const T = {
  EN: {
    ...
    drill: "Open detail", forcePlates: "VALD Assessment", vbt: "VBT / strength", movement: "Match movement",
  ...
  IS: {
    ...
    drill: "Opna nánar", forcePlates: "VALD-mat", vbt: "VBT / styrkur", movement: "Leik-hreyfing",
