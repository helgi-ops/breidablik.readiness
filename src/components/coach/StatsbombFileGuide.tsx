...
const T = {
  EN: {
    ...
    rows: [
      ...
      ["Squad (one row per player)", "Player Season Analysis page", "Key contributors (top output / creator / defender)"],
    ],
  ...
  IS: {
    ...
    rows: [
      ...
      ["Squad (ein röð per leikmann)", "Player Season Analysis síða", "Lykilmenn (mest afköst / skapari / vörn)"],
    ],
