...
const COPY = {
  IS: {
    ...
    axisReady: "Readiness",
    axisPl: "Planned PL",
    axisComposite: "Hlutfallslegt álag (0 = ekkert · 0.5 = baseline · 1.0 = 2×)",
    composite: "Álag vs baseline",
    compositeBands: "0.5 = venjulegur dagur (1.0× baseline) · >0.75 = 1.5× baseline · punktur verður rauður ef composite áhættuskor er hátt",
    usingComposite: "X-ás sýnir raunverulegt þjálfunarálag dagsins miðað við 28-daga meðaltal leikmanns.",
  ...
  EN: {
    ...
    axisReady: "Readiness",
    axisPl: "Planned PL",
    axisComposite: "Relative load (0 = none · 0.5 = baseline · 1.0 = 2×)",
    composite: "Load vs baseline",
    compositeBands: "0.5 = normal day (1.0× baseline) · >0.75 = 1.5× baseline · dot turns red when composite risk is high",
    usingComposite: "X-axis shows actual training load today relative to each player's 28-day average.",
