...
export default function DailyBriefingCard(props: DailyBriefingCardProps) {
  ...
  // NOTE: the in-card "Top attention today" list, its Compact/Detailed toggle,
  // and the decision-trace modal were removed — the flagged-player list now
  // lives ONCE in the standalone "Needs attention" panel (AttentionList), built
  // from the same buildAttentionList source. This card keeps the squad-level
  // read (headline, tiles, team pulse, compliance) which the panel doesn't show.
