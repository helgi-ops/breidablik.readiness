...
const FEATURE_LABELS: Record<MicroPulseFeatureKey, string> = {
  ...
  GPS_LOAD_MONITORING: "GPS Load Monitoring — 7D / 28D / ACWR",
  YESTERDAY_LOAD: "Yesterday Load — auto from Catapult",
  SQUAD_OVERVIEW: "Squad overview",
  INTELLIGENCE_TAB: "Team intelligence",
  LOAD_RPE_TAB: "Load & RPE monitoring",
  WEEK_SETUP: "Week setup & match-week tools",
