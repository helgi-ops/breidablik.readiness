...
const TIER_PLAN: Record<string, { type: StimulusType | null; blend: StimulusBlend; note: Bi }> = {
  ...
  "MD-2": { type: "locomotive", blend: { locomotive: 1, technical: 1 }, note: { en: "Speed day — short max-velocity + sprints + set pieces; low volume, high intensity.", is: "Hraðadagur — stutt hámarkshraði + sprettir + fastir leikþættir; lágt magn, há ákefð." } },
  "MD-1": { type: "technical", blend: { technical: 1, mixed: 1 }, note: { en: "Activation day — short, sharp, low volume + set pieces / tactical (the taper, no fatigue).", is: "Virkjunardagur — stutt, beitt, lágt magn + fastir leikþættir / taktík (niðurtröppun, engin þreyta)." } },
