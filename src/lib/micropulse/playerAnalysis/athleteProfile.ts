...
export const QUALITIES: QualityDef[] = [
  ...
  { id: "aerobic_endurance", en: "Aerobic endurance", is: "Loftháð þol", higherIsBetter: true,
    noteEn: "Critical Speed from his GPS power curve — the sustainable distance-rate, the asymptote of the mean-maximal 1/3/5-min windows. A squad-comparable conditioning read; the track-test CS (higher precision) is on the Conditioning page.", noteIs: "Critical Speed úr GPS power-ferlinum — sjálfbæri vegalengdar-hraðinn, hornréttan á mean-maximal 1/3/5-mín gluggum. Samanburðarhæfur þol-lestur; nákvæmara hlaupapróf-CS er á Þrek-síðunni." },
  { id: "anaerobic_reserve", en: "Anaerobic reserve (D′)", is: "Loftfælinn forði (D′)", higherIsBetter: true,
    noteEn: "D′ from the GPS power curve — the finite distance he covers ABOVE Critical Speed before he must slow. His sprint 'tank': it empties in efforts and refills below CS.", noteIs: "D′ úr GPS power-ferlinum — endanleg vegalengd YFIR Critical Speed áður en hann verður að hægja. Sprett-„tankurinn“: tæmist í átökum, fyllist undir CS." },
